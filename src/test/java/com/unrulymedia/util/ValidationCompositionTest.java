...
public class ValidationCompositionTest {
    ...
    public void shouldComposeListValidation() throws Exception {
        Validation<List<Long>, Object> composed = Validation.compose(() -> Validation.success(Arrays.asList(3L)), () -> Validation.success(Arrays.asList(4L)));
        assertThat(composed,is(Validation.success(Arrays.asList(3L,4L))));
    }

    @Test
    public void shouldComposeSetValidation() throws Exception {
        Validation<Set<Long>, Object> composed = Validation.compose(() -> Validation.success(new HashSet<>(Arrays.asList(3L))), () -> Validation.success(new HashSet<>(Arrays.asList(4L))));
        assertThat(composed,is(Validation.success(new HashSet<>(Arrays.asList(3L, 4L)))));
    }
